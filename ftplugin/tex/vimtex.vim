...
"nmap <F1> :w!<CR> \| :VimtexCompile<CR>
nnoremap <F1> :w!<CR> \| :execute "normal \<Plug>(vimtex-compile)"<CR> 
"nnoremap <F1> :w!<CR> \| :VimtexCompile<CR> \| :sleep 1<CR> \| :if vimtex#compiler#status('latexmk') ==# 'success' \| :VimtexView \| endif<CR>
"nnoremap <F1> :w!<CR> \| :VimtexCompile<CR> \| :if vimtex#compiler#status('latex') ==# 'success' \| :VimtexView \| else \| echo "Compilation failed!" \| endif<CR>
...
let g:vimtex_syntax_custom_cmds = [
  \ {'name': 'Delim', 'argstyle': 'bold', 'mathmode': 1},
\ ]
